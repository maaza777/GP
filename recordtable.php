    ...
    <table class="styled-table" id= "table_id">
      <thead>
        <tr>
          ...
          <th>BPM</th>
          <th>SpO2</th>
          <th>BODYTEMPERATURE (°C)</th>
          <th>TEMPERATURE (°C)</th>
          <th>HUMIDITY (%)</th>
          <th>STATUS READ SENSORS</th>
          <th>TIME</th>
      ...
      <tbody id="tbody_table_record">
        <?php
          ...
          // This table is used to store and record sensors data updated by ESP32. 
          ...
          foreach ($pdo->query($sql) as $row) {
            ...
            echo '<td class="bdr">'. $row['BPM'] . '</td>';
            echo '<td class="bdr">'. $row['Spo'] . '</td>';
            echo '<td class="bdr">'. $row['BodyTemperature'] . '</td>';
            echo '<td class="bdr">'. $row['temperature'] . '</td>';
            echo '<td class="bdr">'. $row['humidity'] . '</td>';
            echo '<td class="bdr">'. $row['status_'] . '</td>';
